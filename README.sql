...
--
-- Dumping data for table `moduleprogress`
--

INSERT INTO `moduleprogress` (`userID`, `moduleID`, `unlocked`, `completed`) VALUES
(888018, 1001, 1, 0),
(888018, 1002, 0, 0),
(888018, 1003, 0, 0),
(888018, 1004, 0, 0),
...
--
-- Dumping data for table `segmentprogress`
--

INSERT INTO `segmentprogress` (`userID`, `segmentID`, `completed`) VALUES
(888018, 2001, 0),
(888018, 2002, 0),
(888018, 2003, 0),
(888018, 2004, 0),
...
(888018, 'bob@ross.com', 'Bob', 'Ross', 'bbbbb'),
(888019, 'newbie@gmail.com', 'New', 'User', '12345');
...
--
ALTER TABLE `user`
  MODIFY `userID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=888020;
